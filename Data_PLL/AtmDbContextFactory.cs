...
namespace Data_PLL
{
    public class AtmDbContextFactory : IDesignTimeDbContextFactory<AtmDbContext>
    {
        ...
        public AtmDbContext CreateDbContext(string[] args)
        {
            ...
            string connectionString = @"Data Source=DESKTOP-BJR8R95\SQLEXPRESS;Integrated Security=True;Connect Timeout=30;Encrypt=False;Initial Catalog=EFCoreDB;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
