...
namespace Data_PLL
{
    public class AtmDbContextFactory : IDesignTimeDbContextFactory<AtmDbContext>
    {
        ...
        public AtmDbContext CreateDbContext(string[] args)
        {
            ...
            string connectionString = @"Data Source=.;Initial Catalog=ATMEFCoreDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
